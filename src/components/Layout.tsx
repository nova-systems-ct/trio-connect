...
const STAFF_NAV: NavItem[] = [
  ...
  { path: "/operations",     label: "Operations",     icon: icon_ops(), activePaths: ["/operations", "/checkin", "/meetings", "/events", "/tasks", "/resources", "/documents"] },
  { path: "/communications", label: "Communications", icon: icon_mail() },
  { path: "/insights",       label: "Insights",       icon: icon_chart(), activePaths: ["/insights", "/reports", "/ai-center"] },
  { path: "/administration", label: "Administration", icon: icon_shield() },
];
...
const BOTTOM_NAV: NavItem[] = [
  { path: "/id-center", label: "ID Center",   icon: icon_id() },
...
export default function Layout({ children, portal = "staff" }: { children: ReactNode; portal?: Portal }) {
  ...
  const currentLabel = [...nav, ...BOTTOM_NAV].find((n) => isItemActive(n))?.label ?? "Dashboard";
...
function icon_shield() { return <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" /></svg>; }
